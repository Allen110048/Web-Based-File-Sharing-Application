...
import {signalingMessageCallback, createPeerConnection} from "./message.js";
...
let percentInfo = document.getElementById('percent');
let probg = document.getElementById('probg');
...
export {socket, upload, probg, progress, percentInfo};